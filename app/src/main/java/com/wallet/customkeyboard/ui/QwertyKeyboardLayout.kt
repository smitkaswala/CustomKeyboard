...
class QwertyKeyboardLayout(context: Context, controller: KeyboardController?) :
    ...
    private fun createLowerCaseRows(): List<LinearLayout> {
        ...
        /*val backgroundTint = ColorStateList.valueOf(context.resources.getColor(R.color.cancel)) // Change to your desired tint color
        cancel.backgroundTintList = backgroundTint*/
...
//        rowFour.add(bcksp)
        ...
        val cancel = createButton("CANCEL", columnWidth * 2.2f, KeyboardController.SpecialKey.DONE)
        val backgroundTint = ColorStateList.valueOf(context.resources.getColor(R.color.cancel)) // Change to your desired tint color
        cancel.textSize = 15f
        cancel.backgroundTintList = backgroundTint
        cancel.setTextColor(context.resources.getColor(R.color.white))

        val confirm = createButton("CONFIRM", columnWidth * 2.5f, KeyboardController.SpecialKey.DONE)
        val confirmTint = ColorStateList.valueOf(context.resources.getColor(R.color.confirm)) // Change to your desired tint color
        confirm.textSize = 15f
        confirm.backgroundTintList = confirmTint

        rowFive.add(cancel)
        rowFive.add(createButton("", columnWidth * 6.0f," "))
        rowFive.add(confirm)
    ...
    private fun createNumbersRow(): LinearLayout {
        ...
        row.add(createButton("⌫", columnWidth, KeyboardController.SpecialKey.BACKSPACE))
        return createRowNumbers(row)
    }
